...
Если игроки спрашивают о книге заклинаний Виктора, он требует узнать их имена и цели. Игроки могут убедить его помочь им, рассказав историю исчезновения Арабель, или успешно выполнив проверку @Check[diplomacy|dc:21|traits:action:make-an-impression]{Дипломатии}.
...
>
> Виктор правдиво говорит игрокам, что пытался сохранить свою магию в тайне от отца, опасаясь его неодобрения. Однако его утверждения о том, что его магия вызвала "призраков" — ложь, и проверка @Check[perception|dc:19|traits:action:sense-motive]{Восприятия} показывает, что он колеблется, рассказывая свою историю, его глаза на мгновение устремляются к зеркалу, прислоненному к стене.
>
...
Когда игроки выходят из хижины Шольдара, любой персонаж, успешно прошедший проверку @Check[perception|dc:24]{Восприятия}, замечает силуэт, наблюдающий за ними из южной линии деревьев. Если игроки приближаются, смотрят в сторону или иным образом пытаются взаимодействовать с силуэтом, он исчезает.
...
* ***Серебряная колючая сеть***: *Дальнобойная атака оружием:* +20 к попаданию (приращение 10 футов). *Попадание:* @Damage[2d10+9][piercing]{20 колющего урона} и цель схвачена, пока не освободится или не обездвижена при критическом успехе. КС Высвобождения 27. Существо, которое пытается это сделать, также должно преуспеть в @Check[reflex|dc:25|basic]{базовой проверке Рефлекса}, иначе получит @Damage[2d10+9][piercing]{колющий урон} в процессе. У сети Твёрдость 10 и 50 ОЗ. Если сеть сломана, существо может автоматически освободиться без вреда, потратив 3 действия (или 1 действие, но потребуется сделать спасбросок Рефлекса).
...
**Вещи Эсмеральды.** Если игроки успешно входят в фургон Эсмеральды, в нём нет сожжённой страницы из дневника ван Рихтена. Кроме того, следующие предметы находятся в фальшивом дне деревянного сундука, которое требует проверки @Check[perception|dc:25|traits:action:search]{Восприятия} для обнаружения:
...
Существо, которое касается любой части двери, кроме кнопок, не отперев её сначала, получает слабый, но болезненный электрический разряд. Существо, пытающееся выломать дверь, должно преуспеть в проверке @Check[athletics|dc:32|traits:action:force-open]{Атлетики}.
...
Успешная проверка @Check[perception|dc:17|traits:action:search]{Восприятия} четвёртого этажа раскрывает одну улику при успехе и обе при критическом успехе:

* Цветной бисерный браслет с несколькими деревянными амулетами детского размера, обёрнутый вокруг посеребрённого кинжала и карты Таррокки (**Закутанный**). (Игрок, который успешно проходит проверку @Check[society|dc:19|traits:action:recall-knowledge]{Общества} или @Check[arcana|dc:19|traits:action:recall-knowledge]{Тайн} для Вспоминания, припоминает, что Закутанный представляет тайны, новоприбывших и скрытые личности.)
...
Если игроки следуют за [[Non-Player Characters#Rictavio|Риктавио]] на Складской двор Арасека вместо того, чтобы ждать его в таверне "Синяя Вода", они могут найти его стоящим на коленях у фургона, где он, похоже, регулирует спицы заднего левого деревянного колеса. Игрок, успешно прошедший проверку @Check[perception|dc:24]{Восприятия}, замечает, что Риктавио снова и снова регулирует одну и ту же спицу, и что его губы двигаются, словно он с кем-то разговаривает. Если игроки наблюдают за ним, он продолжает своё занятие в течение пяти минут — гораздо дольше, чем обычно требуется для такой задачи — прежде чем встать и собраться уходить.
...
***Обратная дорога.*** Встреча с Жолтом и Матильдой более формально представляет стаю оборотней, предвещая [[Arc L - The Den of Wolves]] и обеспечивая, чтобы игроки оценили важность получения посеребрённого оружия перед их встречей с ковеном Старой Костедробилки в [[Акт II - Город в Тенях/Арка H - Потерянная душа]].
